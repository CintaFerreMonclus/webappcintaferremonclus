...
function canvia_seccio(num_boto) {
    ...
    for (let i = 1; i < num_botons; i++) {
        ...
        if (i == num_boto) {
            boto.style.color = "#FFFFFF";    // es destaca la secció activa amb el canvi de colors del botó corresponent
            boto.style.backgroundColor = "#82C9F8";
...
function geoExit(posicio){
    ...
    let color = "red";
    let path = "M12,4A4,4 0 0,1 16,8A4,4 0 0,1 12,12A4,4 0 0,1 8,8A4,4 0 0,1 12,4M12,14C16.42,14 20,15.79 20,18V20H4V18C4,15.79 7.58,14 12,14Z";    // cadena de text de la forma
...
async function inicia_video() {
    const codi_model = "g7okVT-n7m"    // substitueix els asteriscs pel codi del model d'IA que vas crear en una activitat anterior
